...
// bajo la barra. Animación burger→X + stagger de items. Bloquea el scroll (overflow nativo,
// unidekor no usa Lenis) mientras está abierto. Guard de reduced-motion: estados sin animar.
